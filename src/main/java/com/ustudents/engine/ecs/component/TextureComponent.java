...
public class TextureComponent extends Component {
     ...
     */
    public TextureComponent(Texture texture, Vector4f region) {
     ...
     */
    public TextureComponent(Texture texture, Vector4f region, Color tint) {
     ...
     */
    public TextureComponent(Texture texture, Vector4f region, Color tint, Vector2f origin) {
