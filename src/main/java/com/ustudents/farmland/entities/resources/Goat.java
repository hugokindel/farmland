...
public class Goat extends Resource {
    ...
    @Override
    public void init() {
        addComponent(SpriteComponent.class, Resources.loadTexture("Resource/goat.png"),new Vector4f(3 * 128, 5 * 128, 128, 128));
    }

    public void init(SeedRandom random){
        int textureRegionX = 128 * random.generateInRange(0, 3);
        addComponent(SpriteComponent.class, Resources.loadTexture("Resource/goat.png"),new Vector4f(textureRegionX, (random.generateInRange(0, 1) == 0)? 5 * 128 : 7 * 128, 128, 128));
    }
}
